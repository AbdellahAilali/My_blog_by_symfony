...
Feature: User
  ...
  Scenario: load all the users
    ...
    And the JSON node "root[1].birthday" should be equal to "2018-08-01"
    ...
    And the JSON node "root[2].firstname" should be equal to "ben"
    And the JSON node "root[2].lastname" should be equal to "Malik"
    And the JSON node "root[2].birthday" should be equal to "2018-08-01"
