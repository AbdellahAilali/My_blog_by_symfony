...
class UserControllerFunctionalTest extends WebTestCase
{
    ...
    public function testLoadAllUserAction()
    {
        ...
        $expected = '[{"id":"32132dsf132ds1f3ds21fsd","firstname":"Abdellah","lastname":"Ailali","birthday":"2018-07-27","comments":[{"title":"Le chateau ambulant","comment":"ma description"}]}]';

        //echo jspn->getResponse()->getContent()
